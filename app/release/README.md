Deberemos descomprimir el archivo `Appexe.zip` para poder ejecutar la app, en ella encontramos el ejecutable y la carpeta con todos los datos necesarios para la ejecución.
