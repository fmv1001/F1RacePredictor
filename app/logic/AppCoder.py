...
class Coder:
    def __init__(self):
        self.coders = joblib.load('data/models/codificadores.pkl')
        self.all_data = pd.read_csv('data/datacsv/all_data.csv')
        return
    ...
    def encode_result(self, data_result, data_driver, data_circuit, data_constructor):
        ...
        data['driver_awareness'] = data['driver_awareness'].fillna(min(data['driver_awareness']))
