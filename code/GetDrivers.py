...
def create_dataframe(drivers):
    ...
    df_drivers = df_drivers.rename(columns={'driverCode': 'driver_code'})
    df_drivers = df_drivers.rename(columns={'firstName': 'driver_first_name'})
    df_drivers = df_drivers.rename(columns={'lastName': 'driver_last_name'})
