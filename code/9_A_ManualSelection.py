...
df_manual_selecction = df_manual_selecction.drop('race_url', axis=1)
df_manual_selecction = df_manual_selecction.drop('race_date', axis=1)
df_manual_selecction = df_manual_selecction.drop('driver_url', axis=1)
df_manual_selecction = df_manual_selecction.drop('driver_first_name', axis=1)
df_manual_selecction = df_manual_selecction.drop('driver_last_name', axis=1)
df_manual_selecction = df_manual_selecction.drop('driver_date_of_birth', axis=1)
df_manual_selecction = df_manual_selecction.drop('driver_nationality', axis=1)
df_manual_selecction = df_manual_selecction.drop('circuit_url', axis=1)
df_manual_selecction = df_manual_selecction.drop('circuit_name', axis=1)
df_manual_selecction = df_manual_selecction.drop('circuit_locality', axis=1)
...
df_manual_selecction = df_manual_selecction.drop('constructor_url', axis=1)
df_manual_selecction = df_manual_selecction.drop('constructor_name', axis=1)
df_manual_selecction = df_manual_selecction.drop('constructor_nationality', axis=1)
