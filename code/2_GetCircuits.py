...
def google_api_get_elevation(latitud, longitud):
    ...
    if elevation_data["status"] == "OK":
        ...
        global google_api_elevation_errors
        google_api_elevation_errors += 1
        return None
...
print("Se han encontrado las altitudes de " + str((df.__len__() - google_api_elevation_errors)) + " del total de " + str(df.__len__()) + " circuitos.")
